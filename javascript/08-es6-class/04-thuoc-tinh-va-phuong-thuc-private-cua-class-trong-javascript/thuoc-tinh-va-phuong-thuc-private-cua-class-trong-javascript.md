...
► Ngoài cách sử dụng hàm [getter và setter](/getter-va-setter-trong-javascript/), bạn có thể viết hàm bình thường dạng `get...` và `set...` như sau:
...
► Các thuộc tính, phương thức protected với `_` như trên không khác gì các thuộc tính, phương thức thông thường về mặt logic. Vì vậy, chúng có thể được truy cập từ các class kế thừa thông qua prototype hay [từ khóa `extend`](/ke-thua-class-trong-javascript/).

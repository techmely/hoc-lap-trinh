...
- **Lưu thông tin cài đặt của người dùng**: theme ([dark mode](/tao-dark-theme-voi-css-variable/) hay light mode), ngôn ngữ (tiếng việt, tiếng anh), thông tin username/email trong mục bình luận,...

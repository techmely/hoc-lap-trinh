...
Bạn thấy rằng [đối tượng `Date`](/doi-tuong-date-trong-javascript/) đã chuyển sang string. Vì bản thân đối tượng `Date` đã có phương thức `toJSON` trả về string như trên.
